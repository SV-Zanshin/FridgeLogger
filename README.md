...
*Arduino* sketch to log temperature and current consumption data to a microSD card. The statistics collected by this sketch are used to compute various parameters of the refrigerator or freezer. 
